...
class tabBarController: UITabBarController,UITabBarControllerDelegate, UIViewControllerTransitioningDelegate {
  ...
  func configureNav() {
    ...
    lazy private var composedBtn:UIButton = {
        ...
        composedBtn.setImage(UIImage(named: "tabbar_compose_icon_add"), for: UIControl.State())
        composedBtn.setImage(UIImage(named: "tabbar_compose_icon_add_highlighted"), for: UIControl.State.highlighted)
        
        composedBtn.setBackgroundImage(UIImage(named: "tabbar_compose_button"), for: UIControl.State())
        composedBtn.setBackgroundImage(UIImage(named: "tabbar_compose_button_highlighted"), for: UIControl.State.highlighted)

        composedBtn.addTarget(self, action: #selector(self.clickcomposedBtn), for: UIControl.Event.touchUpInside)
